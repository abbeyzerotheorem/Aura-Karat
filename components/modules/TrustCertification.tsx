  ...
  return (
    <StaggerItem>
      <div className="group flex h-full flex-col border border-cream/10 bg-onyx-light/50 p-6 transition-all duration-500 hover:border-champagne/30 hover:bg-onyx-light hover:shadow-luxury-lg">
        <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-full border border-champagne/25 bg-champagne/10 transition-all duration-300 group-hover:border-champagne/40 group-hover:bg-champagne/15">
          <Icon className="h-5 w-5 text-champagne" aria-hidden="true" strokeWidth={1.5} />
        </div>
...
export function TrustCertification() {
  ...
  return (
    <section
      id="trust"
      className="border-y border-whisper bg-onyx py-28 text-cream md:py-36"
